/* KAIRO v20.10.140 — Seller outstanding payment / DP tracking */
(function(){
  'use strict';
  if(window.__KAIRO_SELLER_APP_PREMIUM_V140__) return;
  window.__KAIRO_SELLER_APP_PREMIUM_V140__ = true;
  ...
  function installSellerExpiryTracker(){
    ...
    if(history)history.insertAdjacentElement('beforebegin',card);else dash.appendChild(card);
    return card;
  }
  ...
  function installSellerOutstandingTracker(){
    ...
    const expiry=document.getElementById('seller-expiry-card'),history=document.getElementById('seller-dashboard-history-card');
    if(expiry)expiry.insertAdjacentElement('beforebegin',card);else if(history)history.insertAdjacentElement('beforebegin',card);else dash.appendChild(card);
