/* KAIRO v20.10.137 — Seller expiry tracker + Basic custom-product gating + audit housekeeping */
(function(){
  'use strict';
  if(window.__KAIRO_SELLER_APP_PREMIUM_V137__) return;
  window.__KAIRO_SELLER_APP_PREMIUM_V137__ = true;
