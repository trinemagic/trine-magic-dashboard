...
(function(){
 ...
 function previewReceiptFromSettings(){
   try{
     ...
     const layout=(Array.isArray(draft)&&draft.length?draft:currentLayout()),d={...defaultDesign(),...designDraft};
  ...
  async function maybeBootSellerTemplate(){
    ...
    try{
      ...
      if(!document.getElementById('seller-app-premium-css')){
        ...
        link.rel='stylesheet';
        link.href='assets/templates/seller-app-premium.css?v=20.10.133';
        document.head.appendChild(link);
      }
      if(!document.getElementById('seller-app-premium-js')){
        const script=document.createElement('script');
        script.id='seller-app-premium-js';
        script.src='assets/templates/seller-app-premium.js?v=20.10.133';
        script.defer=true;
